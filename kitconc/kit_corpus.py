...
# Kitconc: Corpus
#
# Copyright (C) 2018-2021 Kitconc Project
# Author: José Lopes Moreira Filho <jlopes@alumni.usp.br>
# URL: <https://pypi.org/project/kitconc/>
...
class Corpus (object):
    ...
    def add_texts(self,source_folder,**kwargs):
        ...
        if language_model == None:
            ...
            # for separated and language models
            if tagged == False:
    ...
    def collocates(self,node,**kwargs):
        ...
        :param lowercase: Letters are converted to lowercase 
        :type lowercase: boolean
        :param measure: Statistic measure tscore or mutual information (default: t-score)
        :type measure: str
    ...
    def delete(self, corpus_name):
        """Deletes a corpus
        :param corpus_name: Path to the corpus file (.zip)
        :type corpus_name: str
        """
...
class Corpora(object):
    ...
    def exists(self, corpus_name):
        if corpus_name in self.list_all():
            return True
        else:
            return False
